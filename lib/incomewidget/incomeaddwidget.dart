...
import 'incomecategoryselect.dart';
...
class IncomeAddWidget extends StatefulWidget {
  ...
  @override
  State<IncomeAddWidget> createState() => _IncomeAddWidgetState();
}

class _IncomeAddWidgetState extends State<IncomeAddWidget> {
  ...
  Future<void> addIncome(BuildContext context) async {
    ...
    // add income to total amount
    int totalincomeamount = totalincome + addincome;
    int newTotalAmount = currentTotalAmount + addincome;
